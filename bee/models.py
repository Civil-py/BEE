...
class EmploymentEquity(models.Model):
    ...
    Description_of_disability = models.CharField(max_length=150, null=True, blank=True)
    Occupational_Level =  models.CharField(max_length=64, null=True, choices=OCCUPATIONAL_LEVEL, blank=True)
    Foreign = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Pilot = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Technician = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Black_Youth = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
...
class Board(models.Model):
    ...
    Race = models.CharField(max_length=64, null=True, choices=RACE_TYPES)
    Gender = models.CharField(max_length=64, null=True, choices=GENDER_TYPES)
    Disabled = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Job_Title = models.CharField(max_length=64, null=True, blank=True)
    Voting_Rights = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Executive_Director = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Independent_Non_Executive = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
...
class SkillsDevelopment(models.Model):
    ...
    Core_and_Critical_Skills = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    ...
    Passed_Qualifying_Examinations = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Spare = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Unemployed_Learner = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Absorbed_Learner = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
...
class Ownership(models.Model):
    ...
    Disabled = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Foreign = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    New_Entrant = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Designated_Groups = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Youth = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Unemployed = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Living_in_Rural_Areas = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Military_Veteran = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Economic_Interest = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Voting_Rights = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Chartered_Accountant = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Outstanding_Debt_by_Black_Participants = models.CharField(null=True, max_length=64, blank=True)
    Ownership_Type = models.CharField(max_length=64, null=True, blank=True)
...
class Procurement(models.Model):
    ...
    Supplier_Classification = models.CharField(max_length=64, null=True, choices=SUPPLIER_CLASSIFICATION, blank=True)
    BEE_Level = models.CharField(max_length=64, null=True, choices=BEE_LEVELS, blank=True)
    Fifty_one_or_more_black_owned = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Black_Ownership =  models.CharField(null=True, max_length=64, blank=True)
    Thirty_or_more_black_woman_owned = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Black_Woman_Ownership = models.CharField(null=True, max_length=64, blank=True)
    Empowering_Supplier = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    ESD_Recipient_Black_Owned_QSE_EME = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Designated_Group_Supplier = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Ingest_date = models.CharField(null=True, max_length=64, blank=True)
    Createdby_user = models.CharField(null=True, max_length=64, blank=True)
    Modifiedby_user = models.CharField(null=True, max_length=64, blank=True)
...
class SocioEconomicDevelopment(models.Model):
    ...
    ICT_Sector_Initiative = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Percentage_of_Black_participation = models.FloatField(null=True, blank=True)
    Contribution_Type = models.CharField(max_length=64, null=True, choices=CONTRIBUTION_TYPES, blank=True)
    Description_of_Contribution = models.CharField(max_length=64, null=True, blank=True)
    Structured_SED_Project = models.CharField(max_length=64, null=True, choices=YES_NO, blank=True)
    Date_of_Contribution = models.CharField(null=True, max_length=64, blank=True)
