...
class SkillsDevelopment(models.Model):
    ...
    Cost_to_company_annual_salary_internal_trainers_CategoryG = models.FloatField(null=True, blank=True)
    Duration_of_training_for_Internal_Training = models.FloatField(null=True, blank=True)
    Cost_to_company= models.FloatField(null=True, blank=True)
    Number_of_Participants_on_Training_Course_CategoryG = models.IntegerField(null=True, blank=True)
...
class Procurement(models.Model):
    ...
    Expenditure_incl_VAT = models.FloatField(null=True, blank=True)
    Expenditure_excl_VAT = models.FloatField(null=True, blank=True)
    ...
    Black_Ownership =  models.FloatField(null=True, blank=True)
